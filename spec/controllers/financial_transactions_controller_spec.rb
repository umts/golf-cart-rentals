...
RSpec.describe FinancialTransactionsController, type: :controller do
  ...
  # FinancialTransactionsController. Be sure to keep this updated too.
  let(:valid_session) { {} }
  ...
  describe 'GET #index' do
    it 'assigns all financial_transactions as @financial_transactions' do
      ...
      expect(assigns(:financial_transactions)).to eq([financial_transaction])
    end
  end
  ...
  describe 'GET #show' do
    it 'assigns the requested financial_transaction as @financial_transaction' do
      financial_transaction = FinancialTransaction.create! valid_attributes
      get :show, { id: financial_transaction.to_param }, valid_session
      expect(assigns(:financial_transaction)).to eq(financial_transaction)
    end
  end

  describe 'GET #new' do
    it 'assigns a new financial_transaction as @financial_transaction' do
  ...
  describe 'DELETE #destroy' do
    ...
    it 'redirects to the financial_transactions list' do
      financial_transaction = FinancialTransaction.create! valid_attributes
      delete :destroy, { id: financial_transaction.to_param }, valid_session
      expect(response).to redirect_to(financial_transactions_url)
    end
  end
end
